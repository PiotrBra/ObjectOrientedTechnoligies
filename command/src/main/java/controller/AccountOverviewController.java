...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		// Pobieramy zaznaczone transakcje
		ObservableList<Transaction> selectedTransactions = transactionsTable.getSelectionModel().getSelectedItems();

		// Sprawdzamy, czy są zaznaczone transakcje
		if (!selectedTransactions.isEmpty()) {
			// Iterujemy po wszystkich zaznaczonych transakcjach i wykonujemy komendę dla każdej z nich
